...
class WordBox {
    ...
    draw(ctx) {
        if (!this.isCollected) {
            ...
            ctx.fillStyle = 'black';
            ctx.font = '40px Arial'; // doubled font size
...
class Game {
    constructor() {
        ...
        // Initialize touchButtons with default values; these will update on mobile.
        this.touchButtons = {
    ...
    setupTouchControls() {
        ...
        this.canvas.addEventListener('touchstart', (e) => {
            ...
            // If game isn't active yet, any tap on a control will start movement.
            if (!this.gameActive) {
                this.gameActive = true;
            }
            if (!this.gameStarted || this.gameOver) {
    ...
    startGame() {
        ...
        // When a game starts, keep snake stationary until a control is tapped.
        this.gameActive = false;
        this.gameOver = false;
    ...
    gameLoop() {
        // Only move the snake if game is active (after a control is tapped)
